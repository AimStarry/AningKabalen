...
@Component({
  ...
  animations: [
    ...
    trigger('cardIn', [transition(':enter', [style({ opacity: 0, transform: 'translateY(16px) scale(.97)' }), animate('320ms ease-out', style({ opacity: 1, transform: 'translateY(0) scale(1)' }))])])
  ]
})
